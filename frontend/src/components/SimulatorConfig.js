...
export const DEVICE_CONFIGS = {
    ...
    ventilator: {
        ...
        safetyRules: [
            ...
            { rule: 'Disconnect Detection', param: 'Pressure', threshold: '< 2 cmH₂O 3 cycles', iso: 'IEC 60601-1-8 §6.3' },
            { rule: 'Low PEEP Alarm', param: 'Pressure', threshold: '< 3 cmH₂O at expiry', iso: 'ISO 80601-2-12 §201.13' },
        ],
        scenarios: [
            ...
            { name: 'Circuit Leak', params: { param: 'leak', bias: 0.4 } },
            { name: 'Pneumothorax', params: { param: 'compliance', bias: -0.9 } },
        ],
    },
    ...
    dialysis: {
        ...
        faultMatrix: [
            ...
            { label: 'High TMP (Clot Factor)', param: 'resistance', bias: 1.5, color: 'red' },
            { label: 'Membrane Clotting', param: 'clog', bias: 0.7, color: 'amber' },
            { label: 'Conductivity Drift', param: 'compliance', bias: -0.5, color: 'amber' },
        ],
        safetyRules: [
            { rule: 'Air Detector Alarm', param: 'BFR', threshold: 'Air detected → clamp', iso: 'ISO 23328-1 §5.4' },
            ...
            { rule: 'Venous Clamp Engaged', param: 'BFR', threshold: 'BFR = 0, Clamp CLOSED', iso: 'ISO 8637-1 §5.6' },
            { rule: 'Conductivity Alarm', param: 'DFR', threshold: 'Deviation > ±10%', iso: 'IEC 60601-2-16 §201.7' },
            { rule: 'Hypotension Alert', param: 'BFR', threshold: 'BFR < 150 mL/min', iso: 'IEC 60601-2-16 §201.12' },
        ],
        scenarios: [
            { name: 'Baseline', params: {} },
            { name: 'High BFR (400 mL/min)', params: { param: 'resistance', bias: 0.5 } },
            { name: 'Membrane Fouling', params: { param: 'clog', bias: 0.6 } },
            { name: 'Air-in-Blood Emergency', params: { param: 'leak', bias: 0.8 } },
            { name: 'Patient Hypotension', params: { param: 'compliance', bias: -0.4 } },
            { name: 'Severe Clotting', params: { param: 'clog', bias: 1.2 } },
        ],
    },
};
